...
test('every invoke channel is wired to a typed DesktopApi method', () => {
  ...
  const api: DesktopApi = {
    ...
    startPi: async () => ({ state: 'stopped', workspace: null, piVersion: null, lastError: null, lastSeenEntryId: null, leafId: null, lastEntryId: null, sessionId: null, sessionFile: null }),
    stopPi: async () => ({ state: 'stopped', workspace: null, piVersion: null, lastError: null, lastSeenEntryId: null, leafId: null, lastEntryId: null, sessionId: null, sessionFile: null }),
    getPiStatus: async () => ({ state: 'stopped', workspace: null, piVersion: null, lastError: null, lastSeenEntryId: null, leafId: null, lastEntryId: null, sessionId: null, sessionFile: null }),
